...
<head>
	...
	<script type="text/javascript">
		...
		function reload(){
			...
			s.src="${pageContext.request.contextPath}/back/code?date="+new Date().getTime();
			$("#enCode").val("");   // 将验证码清空
		}
	</script>
</head>
...
<div class="login">
	<form id="loginForm" action="${pageContext.request.contextPath}/admin/findAll" method="post" >
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<a href="javascript:reload();"> <img  src="${pageContext.request.contextPath}/back/code" alt="验证码" id="image" /></a>
					<%--<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/cod/code" title="点击更换验证码"/>--%>
				</td>
			</tr>
			<tr>
				<td>
